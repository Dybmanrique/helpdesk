...
@section('content')
    <div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form id="formModal">
                        ...
                        @if (auth()->user()->can('Estados de Resolución: Crear') || auth()->user()->can('Estados de Resolución: Actualizar'))
        ...
        <div class="card">
            @can('Estados de Resolución: Crear')
                    ...
                    <table class="table table-md table-striped w-100 my-2 border-top" id="table">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>NOMBRE</th>
                                @if (auth()->user()->can('Estados de Resolución: Actualizar') || auth()->user()->can('Estados de Resolución: Eliminar'))
                                    <th>ACCIONES</th>
                                @endif
                            </tr>
                        </thead>
