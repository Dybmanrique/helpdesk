                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="resolution_state_id" id="resolution_state_id" class="form-select" required>
                                    <option value="" class="d-none">-Seleccione-</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name='file' id="file" required autocomplete="off">
                                @error('file')
                                <div class="form-text text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name='resolution_number' id="resolution_number" required autocomplete="off">
