<div style="background-color:#e5e7eb; color:#111827; padding: 1.5rem; font-family: ui-sans-serif, system-ui, sans-serif">
    <div style="max-width:42rem; margin:auto; background-color:#fff; padding:1.5rem; border-radius:0.5rem">
        ...
        <p>Puede ver el estado de su trámite haciendo clic <a href="#"
                style="text-decoration:none; font-weight:bold; color:#0891b2">AQUÍ</a> o en el enlace de abajo.</p>

        <p>Si necesita más información o tiene alguna pregunta, no dude en contactarnos. Estamos
            aquí para ayudarle.</p>

        <div style="text-align:center; margin-top:1.5rem">
            <a href="#"
                style="text-decoration:none; color: #fff; font-size:1.125rem; font-weight:bold; background-color:#0891b2; border-radius: 0.75rem;padding:0.5rem 1.5rem; margin:auto;display:block; max-width: 300px; word-wrap: break-word;">Ver
                estado de mi trámite</a>
        </div>
