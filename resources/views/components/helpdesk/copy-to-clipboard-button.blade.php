...
<div x-data="{ texto: @js($text), copiado: false }">
    <button
        ...
        "
        class="rounded flex hover:text-indigo-600 dark:hover:text-indigo-400 focus:text-indigo-600 dark:focus:text-indigo-400 focus:outline-none transition duration-300" title="Copiar">
