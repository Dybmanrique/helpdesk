<div>
            ...
            <div class="modal-content">
                <form wire:submit='save'>
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTitle" wire:ignore>REGISTRAR CATEGORÍA DE TRÁMITE</h5>
                    ...
                    @if (auth()->user()->can('Categorías de Trámites: Crear') || auth()->user()->can('Categorías de Trámites: Actualizar'))
    ...
    <div class="card">
        @can('Categorías de Trámites: Crear')
                ...
                <table class="table table-md table-striped w-100 my-2 border-top" id="table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>NOMBRE</th>
                            @if (auth()->user()->can('Categorías de Trámites: Actualizar') ||
                                    auth()->user()->can('Categorías de Trámites: Eliminar'))
                                <th>ACCIONES</th>
                            @endif
                        </tr>
                    </thead>
...
@push('js')
    <script src="{{ asset('js/admin/procedure-categories/crud.js') }}?v={{ env('APP_VERSION') }}"></script>
@endpush
