            ...
            <div class="modal-content">
                <form wire:submit='save'>
                    ...
                    <div class="modal-footer">
                        @if (auth()->user()->can('Estados de Trámites: Crear') || auth()->user()->can('Estados de Trámites: Actualizar'))
                ...
                <table class="table table-md table-striped w-100 my-2 border-top" id="table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>NOMBRE</th>
                            @if (auth()->user()->can('Estados de Trámites: Actualizar') || auth()->user()->can('Estados de Trámites: Eliminar'))
                                <th>ACCIONES</th>
                            @endif
                        </tr>
                    </thead>
