...
(function () {
    ...
    function initDataTable() {
        table = $('#table').DataTable({
            processing: true,
            serverSide: false,
            ajax: "/admin/usuarios-publicos/data",
            columns: [{
                data: null,
                name: 'id',
    ...
    $(`#table tbody`).on('click', '.btn-edit', function () {
        ...
        try {
            selected_item = data;
            document.getElementById('identity_type_id').value = data.person.identity_type_id;
            document.getElementById('identity_number').value = data.person.identity_number;
            document.getElementById('name').value = data.person.name;
            document.getElementById('last_name').value = data.person.last_name;
            document.getElementById('second_last_name').value = data.person.second_last_name;
    ...
    async function save() {
        ...
        try {
            const response = await fetch('/admin/usuarios-publicos/guardar-usuario', {
                method: 'POST',
                headers: {
    ...
    async function update() {
        ...
        formData.append('user_id', selected_item.id);
        formData.append('identity_type_id', document.getElementById('identity_type_id').value);
        formData.append('identity_number', document.getElementById('identity_number').value);
        formData.append('name', document.getElementById('name').value);
        formData.append('last_name', document.getElementById('last_name').value);
        ...
        try {
            const response = await fetch('/admin/usuarios-publicos/actualizar-usuario', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    'Accept': 'application/json'
