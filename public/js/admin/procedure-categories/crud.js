...
(function () {
    ...
    function initDataTable() {
        table = $('#table').DataTable({
            processing: true,
            serverSide: false,
            ajax: "/admin/categorias-de-tramites/data",
            columns: [{
                data: null,
                name: 'id',
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    let buttonActions = '';
                    if (can('Categorías de Trámites: Actualizar')) {
                        buttonActions += `
                    ...
                    if (can('Categorías de Trámites: Eliminar')) {
                        buttonActions += `
    ...
    $(`#table tbody`).on('click', '.btn-edit', function () {
        document.getElementById('modalTitle').textContent = "MODIFICAR CATEGORÍA DE TRÁMITE";
    ...
    $('#modal').on('hidden.coreui.modal', function () {
        document.getElementById('modalTitle').innerText = "REGISTRAR CATEGORÍA DE TRÁMITE";
