...
(function () {
    ...
    function initDataTable() {
        table = $('#table').DataTable({
            processing: true,
            serverSide: false,
            ajax: "/admin/prioridades-de-tramites/data",
            columns: [{
                data: null,
                name: 'id',
    ...
    $(`#table tbody`).on('click', '.btn-edit', function () {
        document.getElementById('modalTitle').textContent = "MODIFICAR PRIORIDAD DE TRÁMITE";
    ...
    $('#modal').on('hidden.coreui.modal', function () {
        document.getElementById('modalTitle').innerText = "REGISTRAR PRIORIDAD DE TRÁMITE";
