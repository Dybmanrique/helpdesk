...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/tipos-de-documentos/data', [DocumentTypeController::class, 'data'])->middleware(['can:Tipos de Documentos: Datos'])->name('admin.document_types.data');
    ...
    Route::get('/categorias-de-tramites/data', [ProcedureCategoryController::class, 'data'])->middleware(['can:Categorías de Trámites: Datos'])->name('admin.procedure_categories.data');
    ...
    Route::get('/prioridades-de-tramites/data', [ProcedurePriorityController::class, 'data'])->middleware(['can:Prioridades de Trámites: Datos'])->name('admin.procedure_priorities.data');
    ...
    Route::get('/estados-de-tramites/data', [ProcedureStateController::class, 'data'])->middleware(['can:Estados de Trámites: Datos'])->name('admin.procedure_states.data');

    Route::get('/oficinas', [OfficeController::class, 'index'])->middleware(['can:Oficinas: Listar'])->name('admin.offices.index');
    Route::get('/oficinas/data', [OfficeController::class, 'data'])->middleware(['can:Oficinas: Datos'])->name('admin.offices.data');
    ...
    Route::get('/todos-los-tramites/data', [AllProceduresController::class, 'data'])->middleware(['can:Todos los Trámites: Datos'])->name('admin.all_procedures.data');
    ...
    Route::get('/tramites-mi-oficina/data', [ProceduresOfficeController::class, 'data'])->middleware(['can:Trámites de mi Oficina: Datos'])->name('admin.procedures_office.data');
    ...
    Route::get('/tipos-de-resolucion/data', [ResolutionTypesController::class, 'data'])->middleware(['can:Tipos de Resolución: Datos'])->name('admin.resolution_types.data');
    ...
    Route::get('/estados-de-resolucion/data', [ResolutionStatesController::class, 'data'])->middleware(['can:Estados de Resolución: Datos'])->name('admin.resolution_states.data');
    ...
    Route::get('/resoluciones/data', [ResolutionsController::class, 'data'])->middleware(['can:Resoluciones: Datos'])->name('admin.resolutions.data');
    ...
    Route::get('/usuarios-administrativos/data', [AdministrativeUsersController::class, 'data'])->middleware(['can:Usuarios: Datos'])->name('admin.administrative_users.data');
    ...
    Route::get('/usuarios-publicos/data', [PublicUsersController::class, 'data'])->middleware(['can:Usuarios: Datos'])->name('admin.public_users.data');
